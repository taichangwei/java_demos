...
public class PooledDataSource implements DataSource {
    ...
    public Connection getConnection(String username, String password) throws SQLException {
        ...
        if (conn == null) {
            conn = opNewConnection();
            idleQueue.add(conn);
        } else {
            System.out.println("Return pooled connection: " + conn.getRealConnection());
        }
        return conn;
    }

    private PooledConnectionProxy opNewConnection() throws SQLException {
